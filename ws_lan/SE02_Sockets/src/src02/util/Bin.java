...
public final class Bin {
	...
	public static void main(String[] args) {
		...
		byte[] timeStampBuff = Bin.longToQWord(timeStamp0);
		System.out.print("Buff:");
		for (int i=7 ; i>=0; i--) {
			System.out.print(" " + timeStampBuff[i]);
		}
		System.out.print("\n");
		long timeStamp1 = Bin.qWordToLong(timeStampBuff);
		System.out.println("timestamp(0): " + timeStamp0);
		System.out.println("timestamp(1): " + timeStamp1);
		//
		byte[] dummyBuffer = Bin.concatBuffers(timeStampBuff, timeStampBuff);
